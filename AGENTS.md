...
- Reference skills for SDK or runtime authoring work best when they mirror the target workflow: authoring workflow -> shape/constraints -> API quick reference -> validation -> debugging -> pitfalls. Point to adjacent specialized skills instead of duplicating their full docs.
